...
export function VaultBrowser({ onOpenEntry }: VaultBrowserProps) {
  const { entries, removeEntry, clear } = usePiiVaultStore();
              ...
              >
                <div className="flex-1 min-w-0">
                  <div className="flex items-center gap-2">
                    <span className="text-sm font-medium truncate">{entry.text}</span>
                    <span className="text-xs px-1.5 py-0.5 rounded bg-[hsl(var(--secondary))] text-[hsl(var(--secondary-foreground))] shrink-0">
                      {entry.category}
                    </span>
                  </div>
                  <div className="flex items-center gap-2 mt-1">
                    <code className="text-xs font-mono bg-[hsl(var(--muted)/0.5)] px-1.5 py-0.5 rounded text-[hsl(var(--muted-foreground))]">
                      {entry.placeholder}
                    </code>
