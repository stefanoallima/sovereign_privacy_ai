...
CLAUDE.md                      → sudd/memory/lessons.md (coding conventions)
```
...
4. **CLAUDE.md conventions**: If `CLAUDE.md` exists in project root:
   - Extract build commands, coding patterns, architectural notes
   - Append to `sudd/memory/lessons.md`:
     ```markdown
     ### [PORTED] Project conventions from CLAUDE.md — {date}
     **Source:** CLAUDE.md
     {extracted conventions}
     ```
