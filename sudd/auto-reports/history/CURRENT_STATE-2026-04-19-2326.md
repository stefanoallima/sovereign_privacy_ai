<!-- refreshed-at: 2026-04-19T19:58:59Z -->
# Current State
...
- [`discovered_audit_stats-rollup-deadfield-fix_01`](changes/active/discovered_audit_stats-rollup-deadfield-fix_01/) — `state.json.stats` ships `{0,0,0,0}` after a session processes 5 changes, and `auto_session.stop_reason` is an empty string. Root cause: the session-end finalization in `cmd/sudd/auto.go:474-489` is…
...
- [`discovered_audit_done-dirty-outcome-tier_01`](changes/stuck/discovered_audit_done-dirty-outcome-tier_01/) — - **Timestamp**: 2026-04-19T19:31:12Z
...
- [`discovered_audit_vision-known-open-work-stale_01`](changes/stuck/discovered_audit_vision-known-open-work-stale_01/) — - **Timestamp**: 2026-04-19T19:04:50Z
...
- State doc refreshed: 2026-04-19T19:58:59Z
