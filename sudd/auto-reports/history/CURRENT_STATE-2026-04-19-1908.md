<!-- refreshed-at: 2026-04-19T17:06:12Z -->
# Current State
...
- [`brown_v3823-current-state-doc_01`](changes/active/brown_v3823-current-state-doc_01/) — Generate a rolling, high-level operational handoff document at `sudd/CURRENT_STATE.md` that answers the question: **"if sudd wakes up with a cleared context, what's the minimum it needs to know to ac…
...
- [`brown_prism-cro-enhancements_01`](changes/archive/brown_prism-cro-enhancements_01_DONE/) — brown_prism-cro-enhancements_01
...
- `brown_v3823-current-state-doc_01` (mode: brown, source: proposal)
...
- State doc refreshed: 2026-04-19T17:06:12Z
